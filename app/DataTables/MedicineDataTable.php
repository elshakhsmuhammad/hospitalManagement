...
class MedicineDatatable extends DataTable {
    ...
    public function dataTable($query) {
        return datatables($query)
            ->addColumn('checkbox', 'admin.medicines.btn.checkbox')
            ->addColumn('edit', 'admin.medicines.btn.edit')
            ->addColumn('delete', 'admin.medicines.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
