...
class StaffDataTable extends DataTable {
    ...
    public function dataTable($query) {
        return datatables($query)
            ->addColumn('checkbox', 'admin.staff.btn.checkbox')
            ->addColumn('edit', 'admin.staff.btn.edit')
            ->addColumn('delete', 'admin.staff.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
    ...
    public function query() {
        return Staff::query()->where(function ($q) {
            if (request()->has('job')) {
