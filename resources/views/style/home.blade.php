...
<html>
    <head>
        <title>{{trans('admin.Hospital_Management_seystem')}}</title>
    ...
    <body>
        <!--start-wrap-->
            ...
            <div class="header">
                ...
                <!--start-logo-->
                <div class="logo">
                    <a href="{{url('/')}}" style="font-size: 30px;">{{trans('admin.Hospital_Management_seystem')}}</a>
                </div>
                <!--end-logo-->
                <!--start-top-nav-->
                <div class="top-nav">
              ...
              <li><a href="{{ aurl('lang/ar') }}"><i class="info "></i> عربى</a></li>
              <li><a href="{{ aurl('lang/en') }}"><i class="dark"></i> English</a></li>
            ...
            <div class="content-grids">
                ...
                <div class="listview_1_of_3 images_1_of_3">
                    ...
                    <div class="text list_1_of_2">
                          ...
                          <div class="button"><span><a href="{{url('/admin')}}">Click Here</a></span></div>
                     </div>
                </div>          
            </div>
            </div>
