<div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ Storage::url($patient->image) }}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{ patient()->user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{ url('patient/logout') }}" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
