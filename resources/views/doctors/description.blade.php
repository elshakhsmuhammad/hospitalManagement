                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            ,old('medicine_id'),['class'=>'form-control']) !!}
                        </div>
                    <div class="form-group">
                       {!! Form::label('type',trans('admin.type')) !!}
                       {!! Form::select('type',['injection'=>trans('admin.injection'),
                        'capsules'=>trans('admin.capsules'),'drink'=>trans('admin.drink')],old('type'),['cla       ss'=>'form-control','placeholder'=>'...']) !!}
                ...
                @foreach( $prescriptions as $prescription)
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-md-2">
                                    <a href="{{url("doctor/task/$prescription->id/edit")}}" class="btn btn-info">
                                        <i class="fa fa-pencil"></i></a></div>

                            </div></td>
                        <td>
                            <div class="col-md-2">
                                <form action="{{route('deletePrescription',$prescription->id)}}" method="post">
